...
[움직이는 스프라이트](/docs/따라하기/2.%20움직이는%20스프라이트.md)에서 만든 맵에 선의 통과를 감지하는 기능을 추가해보겠습니다. 선의 통과를 감지하기 위해서는 [LineCrossingDetector](/API/classes/LineCrossingDetector) Hook과 [SensorLine](/API/classes/SensorLine) Sprite를 사용합니다.
...
[움직이는 스프라이트](/docs/따라하기/2.%20움직이는%20스프라이트.md)에서 만든 코드는 다음과 같습니다.
